...
type PostQuery struct {
	...
	withAuthor *AccountProfileQuery
...
func (_q *PostQuery) QueryAuthor() *AccountProfileQuery {
...
func (_q *PostQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *PostQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *PostQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *PostQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *PostQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *PostQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *PostQuery) WithAuthor(opts ...func(*AccountProfileQuery)) *PostQuery {
	query := (&AccountProfileClient{config: _q.config}).Query()
...
func (_q *PostQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Post, error) {
	...
	if query := _q.withAuthor; query != nil {
		if err := _q.loadAuthor(ctx, query, nodes, nil,
			func(n *Post, e *AccountProfile) { n.Edges.Author = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *PostQuery) loadAuthor(ctx context.Context, query *AccountProfileQuery, nodes []*Post, init func(*Post), assign func(*Post, *AccountProfile)) error {
	...
	query.Where(accountprofile.IDIn(ids...))
