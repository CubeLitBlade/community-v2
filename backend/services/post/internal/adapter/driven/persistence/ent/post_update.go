...
// SetAuthor sets the "author" edge to the AccountProfile entity.
func (_u *PostUpdate) SetAuthor(v *AccountProfile) *PostUpdate {
	...
	if _u.mutation.AuthorCleared() {
		edge := &sqlgraph.EdgeSpec{
			...
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(accountprofile.FieldID, field.TypeInt64),
			},
		}
...
// SetAuthor sets the "author" edge to the AccountProfile entity.
func (_u *PostUpdateOne) SetAuthor(v *AccountProfile) *PostUpdateOne {
	return _u.SetAuthorID(v.ID)
}
