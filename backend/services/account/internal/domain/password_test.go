...
func TestPasswordHashMatches(t *testing.T) {
	...
	if !hash.Matches(validPwd) {
		t.Error("Matches() should return true for correct password")
	}

	if hash.Matches("wrong-password-here") {
		t.Error("Matches() should return false for incorrect password")
	}

	if hash.Matches("") {
		t.Error("Matches() should return false for empty password")
	}

	if hash.Matches(tooLongPassword) {
		t.Error("Matches() should return false for too-long password")
	}
}
